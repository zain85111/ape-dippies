        ...
        <div className={styles.heroBg}>
            ...
            <div className={styles.hero+" container"}>
                <div className={styles.heroMain }>
                    <div className={styles.heroContent}>
                        ...
                        <div className={styles.btnSection}>
                            ...
                            <div>
                                <img className={'cursor margin-right'} src="https://static.wixstatic.com/media/aeb686ff41244d85bc1232fcf7325ec0.png/v1/fill/w_28,h_28,al_c,usm_0.66_1.00_0.01,enc_auto/aeb686ff41244d85bc1232fcf7325ec0.png" alt="Twitter" />
                        ...
                        <div className={styles.heroContentInfo}>
                            <div className={styles.heroContentInfoText}>
                                <span className={styles.heroContentInfoTextMd}>Members</span>
                                <span className={styles.heroContentInfoTextLg}>30000+</span>
                            </div>
                            <div className={styles.infoDivder}></div>
                            <div className={styles.heroContentInfoText}>
                                <span className={styles.heroContentInfoTextMd}>Ape Dippies</span>
                ...
                <div className={styles.heroBanner}>
                    <h1>educate.</h1>
                    <h1 className={styles.coloredText}>invest.</h1>
                    <h1>thrive.</h1>
                </div>
